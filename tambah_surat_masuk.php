                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)){
                                        ...
                                        if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                ...
                                                $_SESSION['penerima'] = 'Form Penerima hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                                echo '<script language="javascript">window.history.back();</script>';
												} else {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user,penerima)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$indeks','$tgl_surat',NOW(),'','$keterangan','$id_user','$penerima')");
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i>
                            <input id="penerima" type="text" class="validate" name="penerima" required>
                                <?php
