                    ...
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
								...
								<td id="right" width="10%"style="border-right:none"> Status:</td>
							...
							<td id="left" colspan="3" style="border-left:yes"><strong>Petunjuk:</strong></td>
							<tr>
								<td id="right" rowspan="2"width"=25%" style="border-right:none;">1.  Unit Keuangan<br/>
								...
								<td width="25%" rowspan="2"style="border-right;none;">
									7.  Seksi Pend. Diniyah dan Pd. Pontren<br/>
									8.  Seksi Peny. haji dan Umroh<br/>
									9. Seksi Peny. Zakat Wakaf<br/>
									10. Pokjawas<br/>
									11. FKUB<br/>
									12. Inmas</td>
									<td id="right" width="25%" style="border-bottom:none">1. Setuju<br/>
									2. Tolak<br/>
									...
									8. Edarkan<br/></td>
									<td id="left" width="25%" style="border-bottom:none">9. Jawab<br/>
									10 Perbaiki<br/>
							...
							<td height="60px" colspan="5">CATATAN: </td></th>
							<tr>
