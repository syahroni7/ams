<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    $query2 = mysqli_query($config, "SELECT institusi, nama, status, alamat, logo, email FROM tbl_instansi");
                    list($institusi, $nama, $status, $alamat, $logo, $email) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Email: '.$email.'</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            <tr>
                                <td class="tgh" id="lbr" colspan="5">TANDA TERIMA SURAT/DOKUMEN</td>
                            </tr>
                            <tr>
                                <td id="right" width="18%"><strong>Indeks Berkas</strong></td>
                                <td id="left" colspan="2" style="border-right: yes;" width="57%">: '.$row['indeks'].'</td>
							...
							<tr>
								...
								<td id="right" colspan="1"><strong>Yang Menerima</strong><br>
								
								</td>
								
                                <td id="left" colspan="2" style="border-right: yes;">: Petugas PTSP,<br/> 
								<div style="height: 60px;"></div><br/>
								<b><strong>'.$row['penerima'].'</strong></b>
								</td>
                            </tr>
							<td style="height: 100px;" class="tgh" id="lbr" colspan="5">-------------------------------------------------------Potong disini ---------------------------------------------------</td>
						...
						echo '
							...
							<br/>
							<tr>
                                <td style="height: 50px;" class="tgh" id="lbr" colspan="5">TANDA TERIMA SURAT/DOKUMEN</td>
                            </tr>
                            <tr>
                                <td id="right" width="18%"><strong>Indeks Berkas</strong></td>
                                <td id="left" colspan="2" style="border-right: yes;" width="57%">: '.$row['indeks'].'</td>
							...
							<tr>
								...
								<td id="right" colspan="1"><strong>Yang Menerima</strong>
								</td>
