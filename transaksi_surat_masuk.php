        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 3){
            ...
            if(isset($_REQUEST['act'])){
                ...
                <?php
					...
					if(isset($_SESSION['succPrint'])){
                        $succprint = $_SESSION['succPrint'];
                        echo '<div id="alert-message" class="row">
                                <div class="col m12">
                                    <div class="card green lighten-5">
                                        <div class="card-content notif">
                                            <span class="card-title green-text"><i class="material-icons md-36">done</i> '.$succPrint.'</span>
                                        </div>
                                    </div>
                                </div>
                            </div>';
                        unset($_SESSION['succPrint']);
                    }
                                  ...
                                  <tr>
                                   ...
                                   if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                      ...
                                      echo '<a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
											...
											<a class="btn small blue waves-effect waves-light" data-position="right" href="?page=trma&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">trma</i>"TANDATERIMA"</a>';
                                    } echo '
                                        </td>
                                    </tr>';
                                }
                                      ...
                                      <tr>
                                        ...
                                        if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                          ...
                                          echo '<a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                ...
                                                <a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=del&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">delete</i> DEL</a>
												<a class="btn small blue waves-effect waves-light" data-position="LEFT" href="?page=trma&id_surat='.$row['id_surat'].'" target="_blank">
                                                    <i class="material-icons">trma</i>"tanda TERIMA"</a>';
                                        } echo '
                                        </td>
                                    </tr>';
                                }
