                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Kantor Kementerian Agama Kabupaten Lebak</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan Siliwangi No. 02 Muara Ciujung Timur Rangkasbitung Telp/Fax. (0252) 201319 Lebak 42314</p>';
                            }
                        }
                    ?>
                </div>
